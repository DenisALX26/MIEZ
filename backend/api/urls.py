...
urlpatterns = [
  ...
  path('inventory/products/<int:id>/', views.InventoryProductDetailView.as_view(), name='inventory_product_detail'),
  ...
  path('contracts/<int:id>/', views.ContractDetailView.as_view(), name='contract_detail'),
  ...
  path('it/technician-stats/', views.TechnicianStatsView.as_view(), name='it_technician_stats'),
  path('it/assets/', views.AssetListCreateView.as_view(), name='asset_list_create'),
  path('it/assets/<int:id>/', views.AssetDetailView.as_view(), name='asset_detail'),
